...
public class AddPromoForm extends Form {
    ...
    public AddPromoForm(Form previous) {
        ...
        Label dateDebut = new Label("Date de début :");
        Picker pickerDateDebut = new Picker();

        
        Label dateFin = new Label("Date de fin :");
        Picker pickerDateFin = new Picker();
        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                {
                    Promo p = new Promo(tfCode.getText(), Double.parseDouble(tfReduction.getText()), pickerDateDebut.getDate() , pickerDateFin.getDate());
        ...
        addAll(code,tfCode,reduction, tfReduction ,dateDebut ,pickerDateDebut , dateFin , pickerDateFin , btnValider);
