    ...
    public AddLivreForm(Form previous) {
        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                {
                    Livre l = new Livre();
                    l.setLibelle(tfLibelle.getText().toString());
                    l.setDescription(taDescription.getText().toString());
                    l.setCategorie(tfCategorie.getText().toString());
                    l.setEditeur(tfEditeur.getText().toString());
                    l.setLangue(tfLangue.getText().toString());
                    l.setPrix(Float.parseFloat(tfPrix.getText()));
                     if( LivreService.getInstance().addLivre(l))
                        {
                           Dialog.show("Success","Livre ajouté avec succés",new Command("OK"));
                        }else
        ...
        addAll(libelle,tfLibelle,description, taDescription ,prix ,tfPrix , categorie , tfCategorie ,langue , tfLangue, editeur , tfEditeur ,btnValider);
